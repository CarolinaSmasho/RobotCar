...
void loop() {
  ...
  if ((sensorValue1 == 1 && sensorValue2 == 1 && sensorValue3 == 1 && sensorValue4 == 1 && sensorValue5 == 1) ||
    ...
    // Start turning right
    timer = millis();
    while (millis() - timer < 2500 && sensorValue1 == 1 && sensorValue2 == 1 && sensorValue3 == 1 && sensorValue4 == 1 && sensorValue5 == 1) {
      turnRightt();
      delay(100);
...
void turnRightt() {
  ...
  digitalWrite(mlf, HIGH);
  digitalWrite(mlb, LOW);
  analogWrite(enaRight, 110);//155
  analogWrite(enaLeft, 110);//255
}
...
void turnLeftt() {
  ...
  digitalWrite(mlf, LOW );
  digitalWrite(mlb, HIGH);
  analogWrite(enaRight, 110);//255
  analogWrite(enaLeft, 110);//155
}
